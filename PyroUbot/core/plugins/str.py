...
<b><emoji id={emot_mention}>👑</emoji> ᴍᴇɴᴛɪᴏɴ:</b> <a href=tg://user?id={client.me.id}>{client.me.first_name} {client.last_name or ''}</a>
"""
    else:
        _ping = f"""
<b>❏ ᴘᴏɴɢ:</b> <code>{str(delta_ping).replace('.', ',')} ms</code>
<b>├ ᴜᴘᴛɪᴍᴇ:</b> <code>{uptime}</code>
<b>╰ ᴍᴇɴᴛɪᴏɴ:</b> <a href=tg://user?id={client.me.id}>{client.me.first_name} {client.last_name or ''}</a>
"""
